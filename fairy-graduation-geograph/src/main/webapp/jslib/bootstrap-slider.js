/**
 * Created by Fairy_LFen on 2017/5/5.
 */
/*! =======================================================
 VERSION  4.4.0              
 ========================================================= */
        ...
        if (b = function (a, b) {
                ...
                _layout: function () {
                    ...
                    if (a = this.options.reversed ? [100 - this.percentage[0], this.percentage[1]] : [this.percentage[0], this.percentage[1]], this.handle1.style[this.stylePos] = a[0] + "%", this.handle2.style[this.stylePos] = a[1] + "%", "vertical" === this.options.orientation)this.trackSelection.style.top = Math.min(a[0], a[1]) + "%", this.trackSelection.style.height = Math.abs(a[0] - a[1]) + "%"; else {
                        ...
                        b.right > c.left ? (this._removeClass(this.tooltip_max, "top"), this._addClass(this.tooltip_max, "bottom"), this.tooltip_max.style.top = "18px") : (this._removeClass(this.tooltip_max, "bottom"), this._addClass(this.tooltip_max, "top"), this.tooltip_max.style.top = this.tooltip_min.style.top)
                    }
                    var d;
                ...
                _offset: function (b) {
                    var c, d, e = 0, f = 0;
                    if (b.offsetParent)do e += b.offsetLeft, f += b.offsetTop, c = a(b).css("transform"), "none" !== c && (d = c.substr(7, c.length - 8).split(","), e += parseInt(d[4], 10), f += parseInt(d[5], 10)); while (b = b.offsetParent);
                    return {left: e, top: f}
                },
                _css: function (b, c, d) {
